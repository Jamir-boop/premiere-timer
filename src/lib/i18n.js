...
export const MESSAGES = {
  en: {
    ...
    ago: "{value} ago",
    author: "Author",
    clearRatingNewSeason: "New season: clear rating",
    ...
    expired: "expired",
    expiryReminderMessage: "24h until real Premier expiry. Rating expires around {date}.",
    expiryReminderTitle: "Premier rating expiry tomorrow",
    fetchError: "Fetch error",
    fetchStatus: "Fetch status",
    githubButton: "GitHub",
    badgeCounter: "Icon day counter",
    historyScanLimited: "Older Steam history still exists. Latest match not found in scanned pages.",
    language: "Language",
    languageAuto: "Auto",
    ...
    ratingCleared: "Rating cleared. Timer resumes after your next sync finds a rating.",
    ...
    remindersPermissionDenied: "Notification permission denied. Reminders stayed off.",
    remindersTooltip: "Sends a browser notification 1 day before your safe play deadline or real Premier expiry.",
    remindersToggle: "1-day reminders",
    safeReminderMessage: "24h until safe play deadline. Play Premier before {date}.",
    safeReminderTitle: "Premier safe deadline tomorrow",
    ...
    steamLoginRequired: "Steam login required in this browser.",
    steamMatchmaking: "Steam matchmaking",
    steamRateLimited: "Steam rate limited request. Try again later.",
    ...
    under24h: "Under 24h",
    under72h: "Under 72h",
    unrankedSeason: "No Premier rank yet. Play Premier to get your new season rating.",
    unrankedSeasonProgress: "No Premier rank yet. Placement wins: {wins}/{target}.",
  ...
  es: {
    ...
    ago: "hace {value}",
    author: "Autor",
    clearRatingNewSeason: "Nueva temporada: limpiar rating",
    ...
    expired: "vencido",
    expiryReminderMessage: "Faltan 24h para el vencimiento real de Premier. El rating vence cerca de {date}.",
    expiryReminderTitle: "Vencimiento de rating Premier mañana",
    fetchError: "Error de consulta",
    fetchStatus: "Estado de consulta",
    githubButton: "GitHub",
    historyScanLimited: "Aun existe historial antiguo de Steam. No se encontro la ultima partida en las paginas escaneadas.",
    ...
    ratingCleared: "Rating limpiado. El timer vuelve cuando la próxima sync encuentre un rating.",
    ...
    remindersPermissionDenied: "Permiso de notificaciones denegado. Los recordatorios quedaron apagados.",
    remindersTooltip: "Envía una notificación del navegador 1 día antes de tu fecha segura o del vencimiento real de Premier.",
    remindersToggle: "Recordatorios de 1 día",
    safeReminderMessage: "Faltan 24h para la fecha segura. Juega Premier antes de {date}.",
    safeReminderTitle: "Fecha segura de Premier mañana",
    ...
    statusEmpty: "Vacío",
    statusError: "Error",
    statusHistoryScanLimited: "Escaneo limitado",
    statusNeedsLogin: "Necesita login",
    statusNever: "Nunca",
    statusNoPermission: "Sin permiso",
    statusNoPremierMatches: "Sin partidas Premier",
    statusOk: "OK",
    statusPaginationUnavailable: "Paginacion no disponible",
    statusRateLimited: "Limitado por tasa",
    statusRatingNotFound: "Rating no encontrado",
    statusUnranked: "Sin rating",
    paginationUnavailable: "Paginacion de historial de Steam no disponible. Usa fallback manual.",
    ...
    steamLoginRequired: "Login de Steam requerido en este navegador.",
    steamMatchmaking: "Steam matchmaking",
    steamRateLimited: "Steam limito la solicitud. Intenta mas tarde.",
    ...
    unrankedSeason: "Aún sin rating Premier. Juega Premier para obtener el rating de la nueva temporada.",
    unrankedSeasonProgress: "Aún sin rating Premier. Victorias de colocación: {wins}/{target}.",
